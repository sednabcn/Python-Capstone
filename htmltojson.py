...
url="file:///home/sedna/Downloads/COURSERA-CAPSTONE/map_toronto.html"
map_toronto_html=urllib.request.urlopen(url).read()
print(map_toronto_html)
map_toronto_json=HTMLtoJSONParser.to_json(map_toronto_html)
print(map_toronto_json)
